...
class Fetch:
    ...
    def update_headers_from_file(self, headers_path: str):
        try:
            self.headers = file.read_json_from_file(headers_path)
        except FileNotFoundError as e:
            raise FileNotFoundError(
                "传入的 headers json 文件不存在"
